...
import main.repository.customer_auth.RoleRepoJpa;
...
public class CustomerAuthController {
    ...
    public ResponseEntity<?> registerUser(@Validated @RequestBody SignupRequest signUpRequest) {
        if (customerAuthRepository.existsByUsername(signUpRequest.getUsername())) {
        ...
        CustomerAuthRepoModel user = new CustomerAuthRepoModel(UUID.randomUUID(),signUpRequest.getUsername(),
                signUpRequest.getEmail(),
                encoder.encode(signUpRequest.getPassword()));
        RoleRepoModel adminRole = roleRepoJpa.findByName(ERole.ROLE_BASIC);
        Set<RoleRepoModel> roles = new HashSet<>();
        roles.add(adminRole);
